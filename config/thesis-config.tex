...
\setcounter{secnumdepth}{4} % Numerazione fino a subsubsection
\setcounter{tocdepth}{4}    % Inclusione nell'indice fino a subsubsection
...
\newcommand{\usecaseactors}[1]{%
\par\noindent\textbf{Attori Principali:} #1.\par\vspace{2pt}}

\newcommand{\usecasepre}[1]{%
\par\noindent\textbf{Precondizioni:} #1.\par\vspace{2pt}}

\newcommand{\usecasedesc}[1]{%
\par\noindent\textbf{Descrizione:} #1.\par\vspace{2pt}}

\newcommand{\usecasepost}[1]{%
\par\noindent\textbf{Postcondizioni:} #1.\par\vspace{2pt}}

\newcommand{\usecasescenario}[1]{%
\par\noindent\textbf{Scenario Principale:}\vspace{-4pt}#1\par\vspace{2pt}}

\newcommand{\usecasegeneralizations}[1]{%
\par\vspace{-4pt}\noindent\textbf{Generalizzazioni:}\vspace{-4pt}#1\par\vspace{2pt}}

\newcommand{\usecaseextensions}[1]{%
\par\vspace{-4pt}\noindent\textbf{Estensioni:}\vspace{-4pt}#1\par\vspace{2pt}}

\newcommand{\usecasealt}[1]{%
\par\vspace{-4pt}\noindent\textbf{Scenario Alternativo:}\vspace{-4pt}#1\par\vspace{2pt}}
