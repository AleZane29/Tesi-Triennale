...
la soluzione utilizza due \emph{design pattern} della letteratura classica (Design Patterns
\cite{gof:design-patterns}) per risolvere problemi ricorrenti dell'instrumentazione.
