...
\begin{description}
  ...
  \item[Server \gls{mcp}:] Il servizio che espone dati e funzionalità all'LLM. Può girare
    ...
    via HTTP con Server-Sent Events). Un server \gls{mcp} può rappresentare un'\gls{api} esterna,
...
Nel modello tradizionale, un microservizio espone una REST \gls{api} che altri servizi chiamano
...
esecuzione di query, chiamate a \gls{api} esterne, rende la sicurezza un tema centrale che
