...
\intro{Il presente capitolo descrive in che modo è stata impiegata l'AI durante lo stage, incentrato sull'uso di un agente di codifica basato su un modello linguistico di grandi dimensioni (\gls{llm}) come \emph{pair engineer} strutturato. Vengono illustrati gli ambiti di utilizzo, il workflow adottato, i benefici in termini di tempo e le mitigazioni adottate per i limiti noti.}\\
...
Una \emph{skill} è orientata al modulo CRUD, nella quale viene spiegato al \gls{llm} a cosa serve quel test, vincoli specifici 
